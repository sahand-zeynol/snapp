...
const title = [];
const ids = [];
const url = "https://app.snapp.taxi/login/";
...
async function run() {
  const phoneNumber = await prompt("What is your phone number?");
  console.log(`Hey there ${phoneNumber}`);
  ...
  await page.click("#cellphone-number-input");
